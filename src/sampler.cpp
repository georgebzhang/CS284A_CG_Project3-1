...
Vector3D CosineWeightedHemisphereSampler3D::get_sample(float *pdf) const { // Lecture 12, Slide 62
  ...
  *pdf = sqrt(1-Xi1) / PI;
  return Vector3D(r*cos(theta), r*sin(theta), sqrt(1-Xi1)); // generate random direction on hemisphere
}
